    ...
    const planes = [
        {
            key: "basico",
            label: "App Básica",
            desc: "App con interfaz gráfica, navegación y funcionalidades estándar.",
            precio: 500,
        },
        {
            key: "avanzado",
            label: "App Avanzada",
            desc: "App con conexión a base de datos, autenticación, notificaciones, integración de APIs, etc.",
            precio: 800,
        },
    ];
    const preciosExtras = { "Publicación en stores": 60, "Soporte 1 mes": 40, "Mantenimiento": 50 };
        ...
        <div className="min-h-screen relative py-20 bg-[url('/code-blue.jpg')] bg-cover bg-center">
            ...
            <div className="container mx-auto px-4 lg:px-6 max-w-3xl relative z-10 bg-gray-900/80 border border-blue-700 rounded-2xl shadow-2xl backdrop-blur-md p-8">
                ...
                <p className="text-lg text-gray-300 mb-8 text-center">
                    Apps personalizadas para tu negocio o idea. Desde una app sencilla hasta soluciones avanzadas con integración de bases de datos y APIs.
                </p>
                <div className="grid md:grid-cols-2 gap-6 mb-10">
                    <div className="flex flex-col items-center bg-gray-800 rounded-xl p-6 border border-gray-700">
                        ...
                        <span className="font-semibold text-white mb-1">App Básica</span>
                        <span className="text-gray-400 text-sm text-center">Interfaz gráfica, navegación y funcionalidades estándar.</span>
                        <span className="text-blue-400 font-bold mt-2">500€</span>
                    </div>
                    <div className="flex flex-col items-center bg-gray-800 rounded-xl p-6 border border-gray-700">
                        <Smartphone className="w-8 h-8 text-purple-400 mb-2" />
                        <span className="font-semibold text-white mb-1">App Avanzada</span>
                        <span className="text-gray-400 text-sm text-center">Conexión a base de datos, autenticación, notificaciones, integración de APIs, etc.</span>
                        <span className="text-purple-400 font-bold mt-2">800€</span>
                    </div>
                </div>
                <div className="bg-blue-900/30 border border-blue-700 rounded-xl p-6 mb-8 text-center">
                    ...
                    <span className="block text-blue-200 mb-2">Desde <span className="font-bold text-2xl text-blue-400">500€</span> (precio orientativo, depende del plan y extras).</span>
                    <span className="block text-gray-400 text-sm">Incluye asesoría, desarrollo y soporte inicial.</span>
                </div>
                        ...
                        <DialogContent className={`${modalBg} ${borderColor} ${shadow}`} style={{ color: '#222' }}>
                            ...
                            <form className="space-y-4" onSubmit={async (e) => {
                                ...
                                <div className="mb-2 text-center">
                                    <span className="text-sm text-gray-500">¿Solo tienes una consulta rápida? <a href="https://wa.me/34657285571?text=Hola%2C%20tengo%20una%20consulta%20sobre%20tu%20servicio%20de%20apps" target="_blank" rel="noopener noreferrer" className="text-green-600 underline hover:text-green-700">Háblame por WhatsApp</a></span>
                                </div>
                                <div>
                                    <label className={`block ${labelText} font-semibold mb-1`}>Tipo de app</label>
