    ...
    const planes = [
        {
            key: "basico",
            label: "Plan Básico",
            desc: "2 reels, 6 historias y 2 posts por semana. Ideal para empezar a mover tu marca.",
            precio: 150,
        },
        {
            key: "intermedio",
            label: "Plan Intermedio",
            desc: "4 reels, 12 historias y 4 posts por semana. Más visibilidad y constancia.",
            precio: 220,
        },
        {
            key: "avanzado",
            label: "Plan Avanzado",
            desc: "6 reels, 18 historias y 6 posts por semana. Máxima presencia y crecimiento.",
            precio: 300,
        },
    ];
    const preciosExtras = { "Diseño de portadas destacadas": 20, "Gestión de comentarios": 30, "Informe de analítica mensual": 25 };
        ...
        <div className="min-h-screen relative py-20 bg-[url('/code-blue.jpg')] bg-cover bg-center">
            ...
            <div className="container mx-auto px-4 lg:px-6 max-w-3xl relative z-10 bg-gray-900/80 border border-blue-700 rounded-2xl shadow-2xl backdrop-blur-md p-8">
                ...
                <p className="text-lg text-gray-300 mb-8 text-center">
                    Planes flexibles para potenciar tu marca en redes sociales. Incluye creación de contenido, estrategia y soporte personalizado.
                </p>
                <div className="grid md:grid-cols-3 gap-6 mb-10">
                    <div className="flex flex-col items-center bg-gray-800 rounded-xl p-6 border border-gray-700">
                        ...
                        <span className="text-gray-400 text-sm text-center">2 reels, 6 historias y 2 posts por semana.</span>
                        <span className="text-yellow-400 font-bold mt-2">150€/mes</span>
                    </div>
                    <div className="flex flex-col items-center bg-gray-800 rounded-xl p-6 border border-gray-700">
                        <Star className="w-8 h-8 text-blue-400 mb-2" />
                        <span className="font-semibold text-white mb-1">Plan Intermedio</span>
                        <span className="text-gray-400 text-sm text-center">4 reels, 12 historias y 4 posts por semana.</span>
                        <span className="text-blue-400 font-bold mt-2">220€/mes</span>
                    </div>
                    <div className="flex flex-col items-center bg-gray-800 rounded-xl p-6 border border-gray-700">
                        <Star className="w-8 h-8 text-purple-400 mb-2" />
                        <span className="font-semibold text-white mb-1">Plan Avanzado</span>
                        <span className="text-gray-400 text-sm text-center">6 reels, 18 historias y 6 posts por semana.</span>
                        <span className="text-purple-400 font-bold mt-2">300€/mes</span>
                    </div>
                </div>
                <div className="bg-blue-900/30 border border-blue-700 rounded-xl p-6 mb-8 text-center">
                    ...
                    <span className="block text-blue-200 mb-2">Desde <span className="font-bold text-2xl text-blue-400">150€</span> (precio orientativo, depende de extras y personalización).</span>
                    <span className="block text-gray-400 text-sm">Incluye asesoría, estrategia, desarrollo de contenido y soporte inicial.</span>
                </div>
                        ...
                        <DialogContent className={`${modalBg} ${borderColor} ${shadow}`} style={{ color: '#222' }}>
                            ...
                            <form className="space-y-4" onSubmit={async (e) => {
                                ...
                                <div className="mb-2 text-center">
                                    <span className="text-sm text-gray-500">¿Solo tienes una consulta rápida? <a href="https://wa.me/34657285571?text=Hola%2C%20tengo%20una%20consulta%20sobre%20tu%20servicio%20de%20redes%20sociales" target="_blank" rel="noopener noreferrer" className="text-green-600 underline hover:text-green-700">Háblame por WhatsApp</a></span>
                                </div>
                                <div>
                                    <label className={`block ${labelText} font-semibold mb-1`}>Plan de redes sociales</label>
                                    <div className="flex flex-col gap-2">
                                        {planes.map((t) => (
                                            <label key={t.key} className="flex items-start gap-2 text-gray-700 cursor-pointer">
                                                ...
                                                <span>
                                                    <span className="font-semibold">{t.label}</span> <span className="text-xs text-blue-600 font-bold">{t.precio}€/mes</span>
